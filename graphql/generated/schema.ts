...
export type Cover = {
  ...
  detail_42?: Maybe<Scalars['String']>;
  detail_117?: Maybe<Scalars['String']>;
  detail_207?: Maybe<Scalars['String']>;
  detail_500?: Maybe<Scalars['String']>;
...
export type SearchQuery = { __typename?: 'Query', search: { __typename?: 'SearchResponse', hitcount: number, works: Array<{ __typename?: 'Work', manifestations: { __typename?: 'Manifestations', first: { __typename?: 'Manifestation', cover: { __typename?: 'Cover', detail?: string | null } } }, titles: { __typename?: 'WorkTitles', main: Array<string> }, creators: Array<{ __typename?: 'Corporation', display: string } | { __typename?: 'Person', display: string }>, subjects: { __typename?: 'SubjectContainer', dbcVerified: Array<{ __typename?: 'Corporation', display: string } | { __typename?: 'Person', display: string } | { __typename?: 'SubjectText', display: string } | { __typename?: 'TimePeriod', display: string }> } }> } };
 ...
 *      suggesttype: // value for 'suggesttype'
 *   },
 * });
 */
export function useSuggestionQuery(baseOptions: Apollo.QueryHookOptions<SuggestionQuery, SuggestionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SuggestionQuery, SuggestionQueryVariables>(SuggestionDocument, options);
      }
export function useSuggestionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SuggestionQuery, SuggestionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SuggestionQuery, SuggestionQueryVariables>(SuggestionDocument, options);
        }
